...
#   MILHARES
    ...
    text = re.sub(r"(\D)1[ ]?([0-9]00)([ ,.?!\r\n€$%])|(\D)1[ ]?(0[0-9]{2})([ ,.?!\r\n€$%])",r"\1\4bmil e \2\3\5\6 ",text) #1xxx -> mil e ... em vez de "1 mil e ..."
    text = re.sub(r"(\D)1[ ]?([0-9]{3})([ ,.?!\r\n€$%])",r"\1cmil \2\3 ",text) #1xxx -> mil e ... em vez de "1 mil e ..."

    text = re.sub(r"(0*[0-9]{1,3})[ ]?000([ ,.?!\r\n€$%])",r"\1 dmil\2",text) #2000, 3000, 217000, ...
    text = re.sub(r"(0*[0-9]00)[ ]?000([ ,.?!\r\n€$%])|0*([0-9]{2}0)[ ]?000([ ,.?!\r\n€$%])|0*([0-9]{3})[ ]?000([ ,.?!\r\n€$%])",r"\1\3\5 emil\2\4\6 ",text) #2000, 3000, 217000, ...
    text = re.sub(r"(0*[1-9][0-9]{0,2})[ ]?([0-9]00)([ ,.?!\r\n€$%])|0*([0-9]{1,3})[ ]?(0[0-9]{2})([ ,.?!\r\n€$%])",r"\1\4 fmil e \2\3\5\6 ",text)
    text = re.sub(r"(0*[1-9][0-9]{0,2})[ ]?([0-9]{3})([ ,.?!\r\n€$%])",r"\1 gmil \2\3",text) #31400, 234200, ...
